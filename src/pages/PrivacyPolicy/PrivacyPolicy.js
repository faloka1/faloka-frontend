  ...
  return (
    <div className="container my-4">
      ...
      <p>
        ...
        the help of <Link to="https://cookie-script.com/privacy-policy-generator" target="_blank" rel="noopener noreferrer">CookieScript Privacy Policy Generator</Link>.</p>
      ...
      <p>
        Faloka will share your information, when applicable, in the following situations:        </p>
      <ul>
        <li><b>With your consent.</b> Faloka will share your information for any purpose with your explicit
          consent.</li>
      </ul>
      ...
      <p>
        ...
        own risk.    </p>
      <p>
        Faloka is not responsible for the performance of websites
